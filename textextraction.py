...
pytesseract.pytesseract.tesseract_cmd = ' C:\\Users\\venky\\PycharmProjects\\StudentFormTask\\venv\\projects\\lib\\site-packages\\tesseract.exe'
...
def show_extract_button(path):
    extractBtn= Button(root,text="click to Extract",command=lambda: extract(path),bg="red",fg="gray",pady=15,padx=15,font=('Times',15,'bold'))
    extractBtn.pack()
